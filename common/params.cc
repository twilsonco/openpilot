...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"ConditionalNavigation", PERSISTENT},
    {"ConditionalSignal", PERSISTENT},
    {"ConditionalSlowerLead", PERSISTENT},
    {"ConditionalSpeed", PERSISTENT},
    {"ConditionalSpeedLead", PERSISTENT},
    {"ConditionalStatus", PERSISTENT},
    {"ConditionalStopLights", PERSISTENT},
    ...
    {"DisplayMemoryUsage", PERSISTENT},
    {"DisplaySLCOffset", PERSISTENT},
    ...
    {"NavigationInstruction", PERSISTENT},
