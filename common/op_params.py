...
class opParams:
  def __init__(self, calling_function=''):
    ...
    self.fork_params = {
      'cluster_speed_smoothing_factor': Param(1.0, float, 'Adjust the smoothing used to determine the "current speed" shown on the Comma device\n', min_val=0.0, max_val=100.0, is_common=True),
