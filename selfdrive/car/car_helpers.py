...
def crash_log(candidate):
  ...
  control_keys, vehicle_keys, visual_keys = [
    "AlwaysOnLateral", "AlwaysOnLateralMain", "ConditionalExperimental", "ConditionalSpeed", "ConditionalSpeedLead", "ConditionalCurves", 
    "ConditionalCurvesLead", "ConditionalNavigation", "ConditionalSignal", "ConditionalSlowerLead", "ConditionalStopLights", "CustomPersonalities", 
    "AggressivePersonality", "AggressiveJerk", "StandardPersonality", "StandardJerk", "RelaxedPersonality", "RelaxedJerk", "DeviceShutdownTimer", 
    "ExperimentalModeViaPress", "FireTheBabysitter", "DisableAllLogging", "MuteDM", "MuteDoor", "MuteSeatbelt", "MuteSystemOverheat", "LateralTuning", 
    "AverageDesiredCurvature", "NNFF", "LongitudinalTuning", "AccelerationProfile", "IncreasedStoppingDistance", "AggressiveAcceleration", "SmootherBraking", 
    "Model", "NudgelessLaneChange", "LaneChangeTimer", "LaneDetection", "OneLaneChange", "PauseLateralOnSignal", "PersonalitiesViaWheel", "SpeedLimitController", 
    "SLCFallback", "SLCPriority", "Offset1", "Offset2", "Offset3", "Offset4", "TurnDesires", "VisionTurnControl", "CurveSensitivity", "TurnAggressiveness", 
    "DisableInternetCheck", "DisableOnroadUploads", "ReverseCruiseIncrease", "TwilsoncoSSH"
  ], [
    "EVTable", "LowerVolt", "LockDoors", "SNGHack", "TSS2Tune"
  ], [
    "CustomTheme", "CustomColors", "CustomIcons", "CustomSignals", "CustomSounds", "Compass", "CustomRoadUI", "LaneLinesWidth", "RoadEdgesWidth", 
    "PathWidth", "PathEdgeWidth", "AccelerationPath", "AdjacentPath", "BlindSpotPath", "DisplayFPS", "LeadInfo", "RoadNameUI", "UnlimitedLength", 
    "DriverCamera", "GreenLightAlert", "RotatingWheel", "ScreenBrightness", "Sidebar", "SilentMode", "SteeringWheel", "WideCameraDisable", "DisplayCPU", 
    "DisplayGPU", "DisplayMemoryUsage", "DisplaySLCOffset", "DisplayStorageLeft", "DisplayStorageUsed", "HideSpeed", "NumericalTemp", "Fahrenheit"
  ]
