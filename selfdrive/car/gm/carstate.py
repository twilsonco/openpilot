...
class CarState(CarStateBase):
  def __init__(self, CP):
    ...
    self.one_pedal_pitch_brake_adjust_bp = [-0.12, -0.02, 0.02, 0.12] # [radians] 0.12 radians of pitch ≈ 12% grade. No change within ±0.02
    self.one_pedal_pitch_brake_adjust_v = [.9, 1., 1., 1.1] # used to scale the value of apply_gas
