...
class CarState(CarStateBase):
  def __init__(self, CP):
    ...
    self.one_pedal_mode_stop_apply_brake_v = [[80., 80., 100., 120., 90.], [100., 100., 160., 180., 120.], [250.]] # three levels. 1-2 are cycled using follow distance press, and 3 by holding
