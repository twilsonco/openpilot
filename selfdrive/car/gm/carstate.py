...
class CarState(CarStateBase):
  def __init__(self, CP):
    ...
    self.one_pedal_mode_stop_apply_brake_v = [[80., 95., 115., 90.], [110., 155., 180., 140.], [280.]] # three levels. 1-2 are cycled using follow distance press, and 3 by holding
    self.one_pedal_mode_apply_brake = 0.
    self.one_pedal_mode_ramp_duration = 0.4
