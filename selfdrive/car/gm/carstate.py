...
class CarState(CarStateBase):
  def __init__(self, CP):
    ...
    self.lead_tr_long_gas_lockout_bp, self.lead_tr_long_gas_lockout_v = [[1.0, 1.3], [1., 0.]] # pass through all cruise engine/regen braking if follow distance < tr * 0.8
    ...
    self.lead_tr_long_brake_lockout_bp, self.lead_tr_long_brake_lockout_v = [[0.7, 0.9], [1., 0.]] # pass through all cruise braking if follow distance < tr * 0.8
