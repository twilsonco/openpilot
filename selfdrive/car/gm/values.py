...
class CarControllerParams():
  def __init__(self):
    ...
    self.STEER_DELTA_UP_BP = [10.0, 20.0] # [m/s]
    self.STEER_DELTA_UP_V = [10.0, 10.0] # [steer command/frame]
    self.STEER_DELTA_DOWN_BP = [10.0, 20.0] # [m/s]
    self.STEER_DELTA_DOWN_V = [15.0, 15.0] # [steer command/frame]
  ...
  EV_GAS_BRAKE_THRESHOLD_BP = [1.5, 1.6, 2.0, 2.65, 4.1, 5.9, 7.9, 10.0, 15.8, 21.8, 28.4, 35.0] # [m/s]
  EV_GAS_BRAKE_THRESHOLD_V = [-0.01, -0.1, -0.25, -0.45, -0.61, -0.74, -0.83, -0.925, -1.06, -1.14, -1.17, -1.18] # [m/s^s]
...
class CAR:
  ...
  VOLT18 = "CHEVROLET VOLT PREMIER 2018"
...
DBC: Dict[str, Dict[str, str]] = defaultdict(lambda: dbc_dict('gm_global_a_powertrain', 'gm_global_a_object', chassis_dbc='gm_global_a_chassis'))
