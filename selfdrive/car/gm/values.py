...
class CarControllerParams():
  def __init__(self):
    ...
    self.EV_GAS_BRAKE_THRESHOLD_BP = [0.0, 1.0, 1.6, 2.4, 3.6, 4.6, 5.4, 12.0, 24.6, 29.0, 33.5] # [m/s]
    self.EV_GAS_BRAKE_THRESHOLD_V = [0.0, -0.1, -0.22, -0.52, -0.62, -0.72, -0.82, -1.1, -1.1, -0.90, -0.8] # [m/s^s]
