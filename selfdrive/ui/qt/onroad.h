...
private:
  void drawIcon(QPainter &p, int x, int y, QPixmap &img, QBrush bg, float opacity, float angle_deg = 0.);
...
protected:
  ...
  inline QColor blueColor(int alpha = 255) { return QColor(0, 100, 255, alpha); }
