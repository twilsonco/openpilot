...
_MAX_LAT_ACC = 2.5  # Maximum lateral acceleration in turns.
_SPLINE_EVAL_STEP = 5  # mts for spline evaluation for curvature calculation
_MIN_SPEED_SECTION_LENGTH = 10.  # mts. Sections below this value will not be split in smaller sections.
