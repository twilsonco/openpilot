        ...
        if key == 'lead0':
          ...
          if self.lead_0.status and not self.mpcs['lead0'].new_lead:
            if self.lead_0_plus.status:
              ...
              tr_leads_desired, _, _ = calc_follow_profile(self.lead_0.vLeadK, self.lead_0_plus.vLeadK, max(0.1, (self.lead_0_plus.dRel - self.lead_0.dRel)), max(0, self.mpcs['lead0'].follow_level - 1), FOLLOW_PROFILES, self.mpcs['lead0']._follow_distance_offsets)
