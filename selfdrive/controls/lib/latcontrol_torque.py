  ...
  def update(self, active, CS, VM, params, steer_limited, desired_curvature, desired_curvature_rate, llk, lat_plan=None, model_data=None):
    ...
    if not active:
      ...
      if self.use_nn or self.use_lateral_jerk:
        ...
        desired_curvature_rate = (interp(0.4, ModelConstants.T_IDXS[:CONTROL_N], lat_plan.curvatureRates) - interp(0.1, ModelConstants.T_IDXS[:CONTROL_N], lat_plan.curvatureRates)) / 0.3
