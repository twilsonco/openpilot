...
_ENTERING_SMOOTH_DECEL_V = [-0.1, -1.5]  # min decel value allowed on ENTERING state
_ENTERING_SMOOTH_DECEL_BP = [1.9, 3.9]  # absolute value of lat acc ahead

# Lookup table for the acceleration for the TURNING state
# depending on the current lateral acceleration of the vehicle.
_TURNING_ACC_V = [1.0, -0.1, -1.5]  # acc value
_TURNING_ACC_BP = [1.0, 1.9, 3.9]  # absolute value of current lat acc
