...
_ENTERING_SMOOTH_DECEL_V = [0.3, 0.0, -1.0]  # min decel value allowed on ENTERING state
_ENTERING_SMOOTH_DECEL_BP = [1.0, 2.2, 3.8]  # absolute value of lat acc ahead

# Lookup table for the acceleration for the TURNING state
# depending on the current lateral acceleration of the vehicle.
_TURNING_ACC_V = [1.0, 0., -1.]  # acc value
_TURNING_ACC_BP = [1.0, 2.2, 3.8]  # absolute value of current lat acc
...
_LOW_SPEED_SCALE_V = [1.3, 1.0] #increase the first value to increase low-speed vision braking; don't touch the second
