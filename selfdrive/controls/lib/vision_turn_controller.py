...
_ENTERING_SMOOTH_DECEL_BP = [1.2, 1.35, 2.8]  # absolute value of lat acc ahead
...
_SPEED_SCALE_V = [1.07, 1.] # [unitless] scales the velocity value used to calculate lateral acceleration
