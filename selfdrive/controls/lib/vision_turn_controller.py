...
_A_LAT_REG_MAX = 1.75  # Maximum lateral acceleration

# Lookup table for the minimum smooth deceleration during the ENTERING state
# depending on the actual maximum absolute lateral acceleration predicted on the turn ahead.
_ENTERING_SMOOTH_DECEL_V = [0.0, -0.2, -1.5]  # min decel value allowed on ENTERING state
_ENTERING_SMOOTH_DECEL_BP = [1.3, 1.525, 2.5]  # absolute value of lat acc ahead

# Lookup table for the acceleration for the TURNING state
# depending on the current lateral acceleration of the vehicle.
_TURNING_ACC_V = [0.6, 0.0, -1.5]  # acc value
_TURNING_ACC_BP = [0.8, 1.8, 2.4]  # absolute value of current lat acc
