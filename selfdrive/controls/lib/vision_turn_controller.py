...
_ENTERING_SMOOTH_DECEL_V = [0.3, 0.0, -1.]  # min decel value allowed on ENTERING state
_ENTERING_SMOOTH_DECEL_BP = [0.8, 1.6, 3.5]  # absolute value of lat acc ahead

# Lookup table for the acceleration for the TURNING state
# depending on the current lateral acceleration of the vehicle.
_TURNING_ACC_V = [1.0, 0., -0.6]  # acc value
_TURNING_ACC_BP = [1.0, 2.4, 3.5]  # absolute value of current lat acc
