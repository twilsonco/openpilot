...
_TURNING_ACC_BP = [1.3, 1.9, 2.9]  # absolute value of current lat acc
...
_LOW_SPEED_SCALE_V = [1.12, 1.0] #increase the first value to increase low-speed vision braking; don't touch the second
