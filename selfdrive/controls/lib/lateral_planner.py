...
class LateralPlanner():
  ...
  def publish(self, sm, pm):
    ...
    plan_send.lateralPlan.trafficMinSeperationLeft = self.LP.lane_offset._left_traffic_mean_sep_dist
    plan_send.lateralPlan.trafficMinSeperationRight = self.LP.lane_offset._right_traffic_mean_sep_dist
