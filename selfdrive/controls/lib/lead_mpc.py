...
FOLLOW_PROFILES = [
  ...
  [ # three-bar
    ...
    2.2,
    [0.8, 1.4, 1.8, 3.5],
    [MPC_COST_LONG.DISTANCE, MPC_COST_LONG.DISTANCE * 0.7, MPC_COST_LONG.DISTANCE * 0.25, MPC_COST_LONG.DISTANCE * 0.1],
    [10., 20., 30., 40.], # meters behind lead car
    [MPC_COST_LONG.DISTANCE, MPC_COST_LONG.DISTANCE * 0.8, MPC_COST_LONG.DISTANCE * 0.25, MPC_COST_LONG.DISTANCE * 0.1],
    0.5 * CV.MPH_TO_MS,
    0.1 * CV.MPH_TO_MS,
    [1.5, 1.8, 2.8], 
