...
class RE:
  ...
  # SEGMENT_NAME = r'[0-9]{4}-[0-9]{2}-[0-9]{2}--[0-9]{2}-[0-9]{2}-[0-9]{2}--[0-9]+'
  # EXPLORER_FILE = r'^({})--([a-z]+\.[a-z0-9]+)$'.format(SEGMENT_NAME)
  # OP_SEGMENT_DIR = r'^({})$'.format(SEGMENT_NAME)
